...
export const ContactSection = () => (
  <section
    id="about-contact"
    className="bg-[var(--background-color)] text-[var(--text-color)] py-16"
  >
    <div className="container mx-auto flex flex-col gap-16">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-t border-[var(--border-color)] pt-8">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <span className="text-lg text-[var(--text-color-muted)]">
            {email}
          </span>
          <span className="text-lg text-[var(--text-color-muted)]">
            {phoneNumber}
